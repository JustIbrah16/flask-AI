...
employee_model = employees_ns.model('Employee', {
    'identificacion': fields.String(required=True, description='Identificación / número de empleado'),
    ...
    'contacto': fields.String(description='Teléfono'),
    ...
    'area': fields.String(description='Área de trabajo'),
    ...
    'numero_cuenta_bancaria': fields.String(description='Número de cuenta bancaria'),
    ...
    'pantalon': fields.String(description='Talla de pantalón'),
    'zapatos': fields.String(description='Talla de zapatos'),
    'abrigo_id': fields.Integer(description='ID talla de abrigo'),
    'eps': fields.String(description='EPS'),
